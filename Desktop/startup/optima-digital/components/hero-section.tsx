  ...
  return (
    <section className="pt-32 pb-20 md:pt-40 md:pb-28 bg-gradient-to-b from-[#f8f9fa] to-white">
      <div className="max-w-[1200px] mx-auto px-4 text-center relative">
        ...
        <ScrollReveal>
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-text mb-6 leading-tight pt-20 md:pt-24">
            Impulsamos negocios en el <span className="text-primary">mundo digital</span>
          </h1>
        </ScrollReveal>
